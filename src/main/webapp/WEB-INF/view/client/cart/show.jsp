  ...
  <body>
    ...
    <div class="container-fluid py-5">
      <div class="container py-5">
        ...
        <div class="${cartDetails.size() == 0 ? "d-none" : "d-block"}">
          ...
          <div class="row g-4 justify-content-start">
            <div class="col-12 col-md-8">
              <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4"></div>
        ...
        <div class="${cartDetails.size() == 0 ? "d-block" : "d-none"}">
          <div class="alert alert-warning" role="alert">
            Không có sản phẩm nào trong giỏ hàng
          </div>
          <a type="button" class="btn btn-success" href="/">Trở về trang chủ</a>
        </div>
      </div>
    </div>
    <!-- Cart Page End -->
