...
<html lang="vi" class="h-100">
  <head>
    ...
    <meta
      name="keywords"
      content="Nền tảng,HTML,CSS,XML,JavaScript, Lập trình C#, Lập trình, Web, Kiến thức, Đồ án"
    />
    <meta name="author" content="Dương Nguyễn Phú Cường" />
    <meta
      name="description"
      content="Cung cấp các kiến thức Nền tảng, cơ bản về Lập trình, Lập trình web, Lập trình di động, Cơ sở dữ liệu, test."
    />
    ...
    <link
      rel="stylesheet"
      href="assets/css/product-detail.css"
      type="text/css"
    />
  </head>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark">
      <div class="container">
        <a class="navbar-brand" href="index.html">Nền tảng</a>
      ...
      <div class="container mt-4">
          ...
          <div class="container-fliud">
            ...
            >
              ...
              <input
                ...
                name="sp_ten"
                id="sp_ten"
                value="Samsung Galaxy Tab 10.1 3G 16G"
              />
              <input
                type="hidden"
                name="sp_gia"
              ...
              <div class="wrapper row">
                  ...
                  <ul class="preview-thumbnail nav nav-tabs">
                    ...
                    <li class="">
                      <a data-target="#pic-3" data-toggle="tab" class="active">
                        <img
                          src="assets/img/product/samsung-galaxy-tab-4.jpg"
                        />
                      </a>
                    </li>
                  </ul>
                ...
                <div class="details col-md-6">
                  ...
                  <small class="text-muted"
                    >Giá cũ: <s><span>10,990,000.00 vnđ</span></s></small
                  >
                  <h4 class="price">
                    Giá hiện tại: <span>10,990,000.00 vnđ</span>
                  </h4>
                  <p class="vote">
                  ...
                  <h5 class="sizes">
                    sizes:
                    <span class="size" data-toggle="tooltip" title="cỡ Nhỏ"
                      >s</span
                    >
                    <span
                      class="size"
                      ...
                      >m</span
                    >
                    <span class="size" data-toggle="tooltip" title="cỡ Lớn"
                      >l</span
                    >
                    <span class="size" data-toggle="tooltip" title="cỡ Đại"
                      >xl</span
                    >
                  </h5>
                  <h5 class="colors">
                  ...
                  <div class="action">
                    <a
                      ...
                      >Thêm vào giỏ hàng</a
                    >
                    <a class="like btn btn-default" href="#"
        ...
        <div class="card">
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col">Vi xử lý Dual-core 1 Cortex-A9 tốc độ 1GHz</div>
            </div>
          </div>
        </div>
      </div>
